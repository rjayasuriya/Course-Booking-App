...
public class LogInStudentSuccess extends AppCompatActivity {
    ...
    public void searchClassByDay(String idIn){//uml check
        ...
        if(output.equals("")){
            display2.setText("No Results");
            display.setText(output);
            return;
        }
        display2.setText("Showing Results:");
        display.setText(output);
    }
    ...
    public void setNewStudentList(String idIn){ // uml check
        String id = idIn;
        DatabaseClasses dbAdmin1 = new DatabaseClasses(LogInStudentSuccess.this);
    ...
    public void viewEnrolledCourses(){// uml check
                    ...
                    if(currEnrolledList!=null){
                        for(String currCourse:currEnrolledList ){
                            ...
                            while (adminList2.isEmpty()==false){
                                ...
                                Log.d("346 Testing show enrolled courses","curr2: "+curr2+",currCourse:"+currCourse);
                                if(curr2.equals(currCourse)){//if the class we have enrolled in matches with total class list
                                    ...
                                    Log.d("347 Testing show enrolled courses","newList: "+newList);
                                }
                            }
                        ...
                        if(newList.equals("")){
                            display.setText("");
                            display2.setText("No Enrolled Classes");
                            return;
                        }
